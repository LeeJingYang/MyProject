...
namespace CoolBBS
{
    public partial class Main : System.Web.UI.MasterPage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                List<Model.Section> hotSection = BLL.SectionBll.GetHotSection();
                dgHotSection.DataSource = hotSection;
                dgHotSection.DataBind();

                List<Model.Dynamic> hotDynamic = BLL.DynamicBll.GetHotDynamic();
                dgHotDynamic.DataSource = hotDynamic;
                dgHotDynamic.DataBind();
            }
            LoadUserInfo();
        }
        ...
        protected void btnAddDynamic_Click(object sender, EventArgs e)
        {
            Response.Redirect("AddNewDynamic.aspx");
        }
